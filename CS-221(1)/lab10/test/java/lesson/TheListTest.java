...
public class TheListTest {
    ...
    private final Integer[] BAD = new Integer[]{ELEM_B, ELEM_A, ELEM_D};
    private final Integer[] BDCD = new Integer[]{ELEM_B, ELEM_D, ELEM_C, ELEM_D};
    private final Integer[] BAC = new Integer[]{ELEM_B, ELEM_A, ELEM_C};
    ...
    */ 
    ...
    /**
       Creates lists and expected values for TestAtIndex
    */
    @DataProvider(name = "addAtIndexProvider2")
    public Object[][] getAddAtIndexList2() {
        // Creates a 2D array - an array of arrays
        // the first object is the starting list,
        // the second object is the expected list
        return new Object[][] {{getList(A), AB}, // test data 2 
                    {getList(AD), ABD}, // test data 3
                    {getList(ACD), ABCD} // test data 4
        };
    }
	...
	contained in the array generated from 'addIndexProvider'.
    */ 
    @Test(dataProvider = "addAtIndexProvider2")
    public void testAddIndex2(TheList<Integer> startList, Integer[] expected){
        // Add the element B at index 1
        startList.add(1, ELEM_B);
        // Check that startlist is now the same as the expected list
        assertTrue(areEqual(startList, expected));
    }
    ...
    */ 
    ...
    /**
       Creates lists and expected values for TestUpdate
    */
    @DataProvider(name = "updateProvider2")
    public Object[][] getUpdateList2() {
        // Creates a 2D array - an array of arrays
        // the first object is the starting list,
        // the second object is the expected list
        return new Object[][] {{getList(BD), BA}, // test data 1
                    {getList(BCD), BAD},// test data 2 
                    {getList(BDCD), BACD} // test data 3
	...
	This method is called once for every set of data
	contained in the array generated from 'updateProvider2'.
    */ 
    @Test(dataProvider = "updateProvider2")
    public void testUpdate2(TheList<Integer> startList, Integer[] expected){
	// call update on startList
	startList.update(1, ELEM_A);
	// check that startList is now the same as the expected list
	assertTrue(areEqual(startList, expected));
    }
    ...
    /**
       Creates lists and expected values for TestGet
    */
    @DataProvider(name = "getProvider")
    public Object[][] getGetList() {
        // Creates a 2D array - an array of arrays
        // the first object is the starting list,
        // the second object is the expected list
        return new Object[][] {{getList(A), A}, // test data 1
                    {getList(BD), B},// test data 2 
                    {getList(DAB), D} // test data 3
	...
	This method is called once for every set of data
	contained in the array generated from 'getProvider'.
    */ 
    @Test(dataProvider = "getProvider")
    public void testGet(TheList<Integer> startList, Integer[] expected){
	// call get on startList
	Integer actual = startList.get(0);
	// check that startList is now the same as the expected list
    ...
    */
    ...
    /**
       Test invalid remove specific element calls that does not exist
       Expects all calls to throw NoSuchElementException
    */
    @Test(dataProvider = "sizedLists",
	  expectedExceptions = NoSuchElementException.class)
