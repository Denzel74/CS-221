 ...
 */
public interface TheList<T> extends Iterable<T>
{
    /**  
    ...
    /**  
     * Adds the specified element before the first element of the list matching the specified target. 
     *
     * @param element the element to be added before the target
     * @param target  the target is the item that the element will be added before
     * @throws NoSuchElementException if target element is not in this list
     */
    ...
    /**  
     * Removes all elements from the list and resets all instance
     * variables
     *
     */
    public void clear();
